...
function contactus() {
  ...
  return (
    <>
      {/* //navbar here */}
      <section id="team">
      <h1 className="title text-center">Our Amazing Team</h1>
      <div className="demo">
        <div className="container text-center">
          <h3 className="title team-title" style={{color:"lavender"}}>Senior Coordinators</h3>
          <div className="row">
            {headsData.map((ele, i) => {
              return (
                <>
            ...
            <h3 className="title" style={{color:"lavender"}}>Student Members</h3>
            <div className="row">
              {studData.map((ele, i) => {
