    ...
    <div className="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <div id="scrollspy1">
        <ul>
          ...
          <li><a className="nav-link scrollto team" target="_blank" href="#team">Team</a></li>
          ...
          <li><a className="getstarted " target="_blank" href="../YIPComingSoon/YIPSoon">Visit YIP</a></li>
